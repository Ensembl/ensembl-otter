...
use Bio::Otter::DBSQL::AnnotatedTranscriptAdaptor;
...
my   $contig = $ag_adaptor->db->get_RawContigAdaptor->fetch_by_dbID(1);
...
print $newtrans2->transcript_info->toString . "\n";

ok(print $newtrans2->transcript_info->toString . "\n");
