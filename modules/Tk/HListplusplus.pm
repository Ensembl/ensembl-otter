...
########################################################################
package Tk::HListplusplus;

use base qw (Tk::Derived Tk::HList);

Construct Tk::Widget 'HListplusplus';
...
Tk::HListplusplus - A HList that supports resizing, open & close of columns, and doesn't force the focus to follow the mouse!
...
=head1 SYNOPSIS
    ...
    # CREATE MY HLIST
    my $hlist = $mw->Scrolled('HListplusplus',
         -columns=>3, 
         -header => 1,
