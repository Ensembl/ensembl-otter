...
sub species_group{
 ...
 $final_species_groups{'species_groups'}{'dev'} = ['apollotest_human', 'human_t2t', 'human_test', 'human_training'];
 $final_species_groups{'species_groups'}{'main'} = ['apollotest_human', 'bos_taurus', 'c_elegans', 'cat', 'chicken', 'chimp', 'cow', 'dog', 'drosophila', 'equus_caballus', 'gibbon', 'gorilla', 'herring', 'herring_test', 'human', 'human_t2t', 'lemur', 'marmoset', 'medicago', 'mouse', 'mus_spretus', 'opossum', 'ovis_aries', 'pig', 'platypus', 'rat', 'rattus_norvegicus', 'sheep', 'sordaria', 'tas_devil', 'tomato', 'tropicalis', 'wallaby', 'wheat', 'zebrafish']; 
 ...
 $final_species_groups{'species_groups'}{'restricted'} =['apollotest_human', 'human_t2t', 'human_test','mouse_test', 'mouse_old', 'mouse_old_test'];
