...
# -host otterpipe2 -port 3303 -user ottadmin -pass lutralutra -dbname pipe_zebrafish -delete -set set1 -set set2 etc.
...
# perl /software/anacode/pipeline/ensembl-pipeline/scripts/Finished/load_from_agp.pl -set chrH_20090616 -description chrH_20090616 -host otterpipe2 -user ottadmin -pass lutralutra -port 3303 -dbname pipe_zebrafish_new ../haplo_agp_090616/chrH.fullagp
# perl /software/anacode/pipeline/ensembl-pipeline/scripts/Finished/load_from_agp.pl -set chrH_20090616 -description chrH_20090616 -host otterlive -user ottadmin -pass lutralutra -port 3301 -dbname loutre_zebrafish ../haplo_agp_090616/chrH.fullagp
...
#        my $command = "perl /software/anacode/pipeline/ensembl-pipeline/scripts/Finished/load_loutre_pipeline.pl -set chr".$chr."_".$moredate." -description \"chrom ".$chr."\" -dbname loutre_zebrafish $agpdir/chr".$chr.".fullagp";
        my $pipeload  = "perl /software/anacode/pipeline/ensembl-pipeline/scripts/Finished/load_from_agp.pl -set chr".$chr."_".$moredate." -description chr".$chr."_".$moredate." -host otterpipe2 -user ottadmin -pass lutralutra -port 3303 -dbname pipe_zebrafish_new $agpdir/chr".$chr.".fullagp";
        my $otterload = "perl /software/anacode/pipeline/ensembl-pipeline/scripts/Finished/load_from_agp.pl -set chr".$chr."_".$moredate." -description chr".$chr."_".$moredate." -host otterlive -user ottadmin -pass lutralutra -port 3301 -dbname loutre_zebrafish $agpdir/chr".$chr.".fullagp";
        eval {&runit($pipeload)};
