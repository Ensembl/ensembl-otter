...
# /software/anacode/pipeline/ensembl-pipeline/scripts/Finished/delete_sequence_set.pl -host otterpipe2 -port 3303 -user ottadmin -pass wibble -dbname pipe_zebrafish -delete -set set1 -set set2 etc.
#
