...
Required arguments:
  ...
  --evegadbname, db_name=NAME              database name NAME
  --evegahost, --dbhost, --db_host=HOST    database host HOST
  --evegaport, --dbport, --db_port=PORT    database port PORT
  --evegauser, --dbuser, --db_user=USER    database username USER
  --evegapass, --dbpass, --db_pass=PASS    database passwort PASS
  --ensemblassembly=ASSEMBLY                 assembly version ASSEMBLY
...
my $altassembly = $support->param('ensemblassembly');
